    ...
    return (
      ...
      >
        <NavHashLink
          ...
          aria-current={this.navHashLinkIsExact(this.props.to) ? 'page' : 'false'}
          {...navLinkProps}
        >
          {this.props.name}
        </NavHashLink>
